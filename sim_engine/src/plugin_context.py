...
class PluginContext:
    ...
    def __init__(self, simulator_engine=None):
        # Optional[SimulatorEngine] — injected by api_server at call time
        self._engine = simulator_engine
    ...
    def run_simulation(
        ...
        if self._engine is None:
            raise RuntimeError("SimulatorEngine not injected into PluginContext")
