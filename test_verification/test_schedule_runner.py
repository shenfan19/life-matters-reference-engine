...
value=0.8 produced 1.1, not 0.8). See models/test_fixtures/valid/test_valid_pulse_reset_bounds_floor.yaml.
"""
...
def test_pulse_value_not_inflated_by_nonzero_bounds_floor(tmp_path):
    ...
    model_name = 'test_fixtures/valid/test_valid_pulse_reset_bounds_floor'
