...
def _run_nsga2(evaluate, n_var, n_obj, n_con, xl, xu, pop_size, n_gen, seed, objectives,
    ...
    try:
        ...
        # KNOWN ISSUE (life-matters-home/L1_engine/task_index.md, category B, found 2026-08-14):
        ...
        # production — CLI and API always pass progress_callback — but any new
        # direct caller of run_optimizer() without one will hit it immediately.
