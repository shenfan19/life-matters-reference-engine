...
class Simulation:
    ...
    def get_current_state(self) -> Dict[str, Any]:
        # 获取当前变量状态。
        return {name: {"value": var.value, "unit": var.unit, "description": var.description} 
    ...
    def reset_simulation(self):
        ...
        for var_name in self.variable_history:
            self.variable_history[var_name] = [self.variable_history[var_name][0]]
